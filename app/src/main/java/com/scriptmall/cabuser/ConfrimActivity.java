...
public class ConfrimActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    TextView picktv, droptv, ridetype;
    int pos;
    Spinner spinpay;
    String paytype;
    String datetime, ride_type, cityName;
    TextView tvcab, tvamt, tvapply;
    EditText etcoupen;

    Button book;
    String uid, currentDateTimeString, ride;
    float amt;
    String cabtype, seats, ptpamt, rentamt, outamt, outroundamt, outwaitingamt, driveramt;
    ProgressDialog loading;
    String ambulanceListingId, price;
    ...
    private void initilizeControl() {
        ...
        recycler_view.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler_view, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                price = ambulanceListing.getRentalFare();
                SharedPreferences.Editor editorLofin = getSharedPreferences("ADMIN_DRIVER_ID", MODE_PRIVATE).edit();
                editorLofin.putString("DRIVER_ID", ambulanceListingId);
                editorLofin.apply();
            }
...
//        });
        ...
        book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ambulanceListingId == null) {
                    Toast.makeText(getApplicationContext(), "Please select Ambulance", Toast.LENGTH_SHORT).show();
                } else if (!ambulanceListingId.equals(null)) {
                    ConnectivityManager conMgr = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
                    NetworkInfo netInfo = conMgr.getActiveNetworkInfo();
                    if (netInfo == null) {
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            String duration = "";
            if (result.size() < 1) {
//                Toast.makeText(getBaseContext(), "Driver is not available at this range", Toast.LENGTH_SHORT).show();
                amt = 0;
                return;
            }
...
//            Toast.makeText(getApplicationContext(), dis, Toast.LENGTH_SHORT).show();
    ...
    private void insertdb() {
        ...
        currentDateTimeString = sdf1.format(new Date());

        loading = ProgressDialog.show(ConfrimActivity.this, "Please wait...", "Sending...", false, true);
...
//                        Toast.makeText(ConfrimActivity.this, response, Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toast.makeText(ConfrimActivity.this, message, Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                HashMap<String, String> params = new HashMap<String, String>();
                params.put(Config.RDATE, currentDateTimeString);
    ...
    public void showJson(String response) {
        try {
            ...
            if (resp.equalsIgnoreCase("Booking successfull")) {
                ...
                final Dialog dialog = new Dialog(ConfrimActivity.this);
...
//                al.setMessage("Your booking has been completed");
////                al.setPositiveButton("My Appointments", new DialogInterface.OnClickListener() {
////                    @Override
...
//        inflater.inflate(R.menu.prof, menu);
    ...
    private void getAmbulanceListing() {
        ...
        loading = ProgressDialog.show(ConfrimActivity.this, "Please wait...", "Fetching...", false, false);
...
//                        Toast.makeText(MainActivity.this, response, Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("city", cityName);
//                if (cabtype.equalsIgnoreCase("VIP")){
//                    cabTypeVal="1";
//                }else if (cabtype.equalsIgnoreCase("EXECUTIVE")){
//                    cabTypeVal="2";
//                }else if (cabtype.equalsIgnoreCase("STANDARD")){
//                    cabTypeVal="3";
//                }
//                params.put("cab_type", cabTypeVal);
                return params;
            }
        };
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    String name = eve.getString("fname") + " " + eve.getString("lname");
                    String rentalFare = eve.getString(cityName);
